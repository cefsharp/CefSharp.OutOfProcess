...
namespace CefSharp.OutOfProcess.WinForms.Example
{
    partial class AboutBox : Form
    {
        ...
        public AboutBox(string cefSharpVersion, string cefVersion, string chromiumVersion)
        {
            InitializeComponent();
            ExecutingAssembly = Assembly.GetExecutingAssembly();

            Text = "About CefSharp OutOfProcess Example";
            labelProductName.Text = AssemblyProduct;
            labelVersion.Text = String.Format("Version {0} ", cefSharpVersion);
